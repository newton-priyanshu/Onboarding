...
import { BookOpen, BookText, Users, FileText, ClipboardCheck, Lock, CheckCircle2, AlertCircle, RefreshCw, ArrowLeft, type LucideIcon } from 'lucide-react';
      ...
      <div className="lux-container" style={{ maxWidth: '900px', margin: '0 auto' }}>
        ...
        <div style={{ marginBottom: '2.5rem' }}>
          ...
          <h1 style={{
            ...
            Phase 3: <em style={{ fontStyle: 'italic', color: ACCENT }}>Ownership</em>
          </h1>
          <p style={{ fontFamily: t.body, fontSize: '0.85rem', color: t.wg }}>
            Days 61–90 — Teach independently, design assessments, and propose course improvements.
          </p>
