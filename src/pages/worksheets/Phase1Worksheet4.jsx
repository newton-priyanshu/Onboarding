...
export default function Phase1Worksheet4() {
  ...
  if (loaded && data._savedReviewStatus === 'approved') return <ApprovedView msg="Your University Governance worksheet has been reviewed and approved." path="/phase-1" />;
  if (data.status === 'submitted' && loaded && data._savedReviewStatus !== 'needs_revision') return <SubmittedView msg="University Governance worksheet submitted." path="/phase-1" />;
