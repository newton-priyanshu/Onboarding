...
export default function Phase2Worksheet1() {
  ...
  if (loaded && data._savedReviewStatus === 'approved') return <ApprovedView msg="Your Doubt Resolution log has been reviewed and approved." path="/phase-2" />;
  if (data.status === 'submitted' && loaded && data._savedReviewStatus !== 'needs_revision') return <SubmittedView msg="Student doubt log submitted." path="/phase-2" />;
