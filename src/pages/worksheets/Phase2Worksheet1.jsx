...
export default function Phase2Worksheet1() {
  ...
  if (loaded && data._savedReviewStatus === 'approved') return <ApprovedView msg="Your Doubt Resolution log has been reviewed and approved." path="/phase-2" reviewerName={data._savedReviewerName} date={data._savedReviewedAt} />;
  if (data.status === 'submitted' && loaded && data._savedReviewStatus !== 'needs_revision' && data._savedReviewStatus !== 'revision_submitted') return <SubmittedView msg="Student doubt log submitted." path="/phase-2" />;
