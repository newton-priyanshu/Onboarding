      ...
      {({ data, updateField }) => (
        <>
          ...
          <WorksheetSection title="10-Minute Window">
            <FieldGroup label="Plan your ideal 10-minute teaching window (minute by minute)" id="minuteByMinute">
              <textarea id="minuteByMinute" className="lux-textarea" rows={5} value={data.minuteByMinute as string} onChange={e => updateField('minuteByMinute', e.target.value)}
            ...
            <FieldGroup label="Transition strategy between segments" id="transitionStrategy">
              <textarea id="transitionStrategy" className="lux-textarea" rows={3} value={data.transitionStrategy as string} onChange={e => updateField('transitionStrategy', e.target.value)}
                placeholder="How will you move smoothly between activities?" />
            </FieldGroup>
          </WorksheetSection>
          <WorksheetSection title="Reflection">
            <FieldGroup label="What's your biggest time management challenge?" id="biggestChallenge">
              <textarea id="biggestChallenge" className="lux-textarea" rows={2} value={data.biggestChallenge as string} onChange={e => updateField('biggestChallenge', e.target.value)} />
            </FieldGroup>
          </WorksheetSection>
        </>
      )}
