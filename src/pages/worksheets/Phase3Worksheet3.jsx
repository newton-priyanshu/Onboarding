...
export default function Phase3Worksheet3() {
  ...
  if (loaded && data._savedReviewStatus === 'approved') {
    return <ApprovedView msg="Your Risk Management & Mitigation worksheet has been reviewed and approved." path="/phase-3" reviewerName={data._savedReviewerName} date={data._savedReviewedAt} />;
  }
