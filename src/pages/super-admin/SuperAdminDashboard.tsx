        ...
        <div style={{ marginTop: '3rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
            {[
              ...
              { title: 'Platform Analytics', desc: 'Detailed cross-campus reports and insights', path: '/super-admin/analytics', icon: BarChart3, color: '#1565C0', disabled: false },
              { title: 'Audit Log', desc: 'Track all platform changes and user actions', path: '/super-admin/audit-log', icon: Clock, color: '#37474F', disabled: false },
            ].map(link => {
