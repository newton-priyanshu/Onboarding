...
import { BookOpen, MessageSquare, ClipboardCheck, FileText, Monitor, Shield, ArrowRight, CheckCircle2, AlertTriangle, Lock } from 'lucide-react';
...
export default function Phase2() {
  ...
  useEffect(() => {
    if (user) (async () => {
      ...
      if (data) {
        const m = {};
        // Build full submission-like objects for phase check
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0, overflow: 'hidden' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' }}>
                    <span style={{ fontFamily: t.body, fontSize: '0.85rem', fontWeight: 500, color: t.ch, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', maxWidth: '100%' }}>W{ws.num}: {ws.title}</span>
