  ...
  return (
    <div className="lux-section">
      <div className="lux-container" style={{ maxWidth: '900px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: '1rem', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              <h1 style={{ fontFamily: theme.fontHeading, fontSize: '2rem', fontWeight: 400, letterSpacing: '-0.02em', color: theme.charcoal, marginBottom: '4px' }}>
                Phase 3: <em style={{ fontStyle: 'italic', color: theme.gold }}>Ownership</em>
              </h1>
              <span style={{ fontFamily: theme.fontBody, fontSize: '0.75rem', color: theme.warmGrey, letterSpacing: '0.05em' }}>Days 61–90 — 5 worksheets + Gate Control</span>
            </div>
          </div>
        ...
        <div onClick={() => navigate('/phase-3/gate-3')}
        ...
        >
          ...
          <div style={{ flex: 1 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' }}>
              <span style={{ fontFamily: theme.fontBody, fontSize: '0.85rem', fontWeight: 500, color: theme.gold }}>Gate Control 3 — 90-Day Final Readiness Assessment</span>
              <ReviewerBadge worksheetId="gc3" />
            </div>
            <p style={{ fontFamily: theme.fontBody, fontSize: '0.75rem', color: theme.warmGrey, marginTop: '2px' }}>Final sign-off — determines independence level</p>
          </div>
